# Turbid coastal reefs act as paradoxical climate refugia for corals
...
Naturally stressful reef environments can enhance coral thermal tolerance, yet whether chronic stress exposure improves or erodes baseline coral performance remains unresolved. Combining three years of in situ monitoring with satellite-derived data across Brazil's Abrolhos Bank, we used Bayesian hierarchical and Joint Species Distribution Models (JSDMs) to assess the health, growth, and competitive dynamics of the endemic reef-building coral Mussismilia hispida against the magnitude and multiscale variability of temperature (SST), chlorophyll-a (Chl-a), light (Daily Light Integral; DLI), and acute thermal stress (DHW > 4). Reef walls of turbid coastal reefs emerged as paradoxical refugia: despite the highest environmental instability and 15-fold more frequent acute thermal stress events, they supported the healthiest corals, underpinned by lower DLI, cooler SST, and elevated Chl-a. Habitat type best predicted health, with walls outperforming reef tops and rocky reefs. Monthly-scale environmental variability conferred further health benefit, consistent with an acclimatization mechanism operating at the timescale of symbiont and lipid dynamics. JSDMs identified DLI as the primary driver of benthic composition, with macroalgal dominance over M. hispida increasing under higher irradiance. Environmental variability further modulated competition: SST and DLI variability suppressed macroalgae, whereas Chl-a and DLI fluctuations favored crustose coralline algae (CCA). We propose that dynamic coastal environments protect corals through a dual mechanism: acclimatization arenas promoting thermal tolerance at lower physiological costs, and ecological filters that suppress competitors while favoring facilitators. Protecting these variable yet functionally critical refugia is a conservation priority in a rapidly warming ocean.
