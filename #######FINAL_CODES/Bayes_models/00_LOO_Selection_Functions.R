...
model_combinations <- list(
  list(name = "FULL",      include_hab = TRUE,  include_depth = TRUE),
  list(name = "NOHABITAT", include_hab = FALSE, include_depth = TRUE),
  list(name = "NODEPTH",   include_hab = TRUE,  include_depth = FALSE),
  list(name = "MINIMAL",   include_hab = FALSE, include_depth = FALSE)
)
